ActiveAdmin.register PartinTakeLog do
  menu parent: 'partin_logs', label: '广告参与', priority: 3
...
index do
  ...
  column '参与结果', sortable: false do |o|
    o.resultable.blank? ? '无' : link_to(o.resultable.format_name, [:admin, ( o.resultable.try(:redpack) || o.resultable.try(:card))])
  end
